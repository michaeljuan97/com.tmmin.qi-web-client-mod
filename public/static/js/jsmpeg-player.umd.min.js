...
!(function (A, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(t)
    : ((A = "undefined" != typeof globalThis ? globalThis : A || self).JSMpeg =
        t());
})(this, function () {
  ...
  var e = (A) => "string" == typeof A && A.constructor === String,
    s = (A) => "Promise" === Object.prototype.toString.call(A).slice(8, -1);
  var I = "WJ3NAvwFY9",
    o = "tR2-0dd-e1",
    g = "ZgIIHVSSYI",
    a = "kAA8SjbHe2",
  ...
  var C = (function () {
      function t(t, i, s, I) {
        var o = void 0 === s ? {} : s,
          ...
          Q = o.autoplay,
          E = void 0 !== Q && Q,
          r = o.autoSetWrapperSize,
          n = void 0 !== r && r,
          h = o.loop,
          d = void 0 !== h && h,
          c = o.control,
          l = void 0 === c || c,
          u = o.decodeFirstFrame,
          w = void 0 === u || u,
          D = o.picMode,
          p = void 0 !== D && D,
          f = o.progressive,
        ...
        void 0 === I && (I = {}),
          ...
          (this.player = null),
          (this.els = {
            wrapper: e(t) ? document.querySelector(t) : t,
            canvas: null,
      ...
      var i = t.prototype;
      return (
        (i.initCanvas = function () {
          this.options.canvas
            ? (this.els.canvas = e(this.options.canvas)
                ? document.querySelector(this.options.canvas)
                : this.options.canvas)
            : ((this.els.canvas = document.createElement("canvas")),
              this.els.canvas.classList.add(I),
              this.els.wrapper.appendChild(this.els.canvas));
        }),
        (i.initPlayer = function () {
          var t = this;
          this.options = A(this.options, { canvas: this.els.canvas });
          var i = A({}, this.options, { autoplay: !1 });
          if (
            ((this.player = new G(this.options.videoUrl, i, {
              play: function () {
                t.options.needPlayButton && t.els.playButton.classList.add(B),
                  t.els.poster && t.els.poster.classList.add(B),
                  t.options.hooks.play();
              },
              pause: function () {
                t.options.needPlayButton &&
                  t.els.playButton.classList.remove(B),
                  t.options.hooks.pause();
              },
              stop: function () {
                t.els.poster && t.els.poster.classList.remove(B),
            ...
            !this.options.poster ||
              ...
              this.els.poster.classList.add(o),
            ...
            (this.options.autoplay || this.player.options.streaming) &&
              this.els.playButton.classList.add(B),
            ...
            (this.options.autoplay || this.player.options.streaming) &&
              ...
              this.els.unmuteButton.classList.add(a),
        ...
        (i.initPlayButton = function () {
          this.options.needPlayButton &&
            (this.els.playButton.classList.add(g),
        ...
        (i._autoSetWrapperSize = function () {
          var A = this;
          if (!this.options.autoSetWrapperSize) return Promise.resolve();
        ...
        (i.onUnlockAudio = function (A, t) {
          var i = this;
          this.els.unmuteButton && (t.preventDefault(), t.stopPropagation()),
            this.player.audioOut.unlock(function () {
              i.els.unmuteButton && i.els.unmuteButton.classList.add(B),
        ...
        (i.onClick = function () {
          this.options.control &&
            (this.player.isPlaying ? this.pause() : this.play());
        }),
    ...
    r = function (A) {
      for (
        var t = window.atob(A), i = t.length, e = new Uint8Array(i), s = 0;
        s < i;
        s++
      )
        e[s] = t.charCodeAt(s);
    ...
    h = (function () {
      ...
      return (
        ...
        (t.start = function () {
          ...
          (this.request = new XMLHttpRequest()),
            (this.request.onreadystatechange = function () {
              A.request.readyState === A.request.DONE &&
                ((A.fileSize = parseInt(
                  A.request.getResponseHeader("Content-Length"),
                  10
                )),
                A.loadNextChunk());
            }),
        ...
        (t.loadNextChunk = function () {
          ...
          (this.isLoading = !0),
            (this.loadStartTime = Q()),
            (this.request = new XMLHttpRequest()),
            (this.request.onreadystatechange = function () {
              A.request.readyState === A.request.DONE &&
              A.request.status >= 200 &&
              A.request.status < 300
                ? A.onChunkLoad(A.request.response)
                : A.request.readyState === A.request.DONE &&
                  A.loadFails++ < 3 &&
                  A.loadNextChunk();
            }),
        ...
        (t.onChunkLoad = function (A) {
          ...
          (this.established = !0),
            ...
            this.destination && this.destination.write(A),
            (this.loadTime = Q() - this.loadStartTime),
      ...
      function A(A, t) {
        (this.url = A),
          ...
          (this.reconnectInterval =
            void 0 !== t.reconnectInterval ? t.reconnectInterval : 5),
    ...
    c = (function () {
      function A(t, i) {
        "object" == typeof t
          ? ((this.bytes = t instanceof Uint8Array ? t : new Uint8Array(t)),
            (this.byteLength = this.bytes.length))
          : ((this.bytes = new Uint8Array(t || 1048576)),
            (this.byteLength = 0)),
        ...
        (t.evict = function (A) {
          ...
          0 !== t &&
            (this.bytes.copyWithin
              ...
              : this.bytes.set(this.bytes.subarray(t, this.byteLength)),
            (this.byteLength -= t),
            (this.index -= t << 3));
        }),
        (t.write = function (t) {
          ...
          if (i) {
            e = 0;
            for (var I = 0; I < t.length; I++) e += t[I].byteLength;
          } else e = t.byteLength;
          if (e > s)
            if (this.mode === A.MODE.EXPAND) {
              var o = Math.max(2 * this.bytes.length, e - s);
              this.resize(o);
            } else this.evict(e);
          if (i)
            for (var g = 0; g < t.length; g++) this.appendSingleBuffer(t[g]);
          else this.appendSingleBuffer(t);
          return e;
        }),
        ...
        (t.findNextStartCode = function () {
          for (var A = (this.index + 7) >> 3; A < this.byteLength; A++)
            if (
              ...
              return (this.index = (A + 4) << 3), this.bytes[A + 3];
        ...
        (t.peek = function (A) {
          for (var t = this.index, i = 0; A; ) {
            var e = 8 - (7 & t),
              ...
              I = e - s;
            (i =
              (i << s) | ((this.bytes[t >> 3] & ((255 >> (8 - s)) << I)) >> I)),
              (t += s),
              (A -= s);
          }
          return i;
    ...
    return (
      ...
      (t.write = function (A) {
        if (this.leftoverBytes) {
          ...
          (this.bits = new c(t)), this.bits.write([this.leftoverBytes, A]);
        } else this.bits = new c(A);
        for (; this.bits.has(1504) && this.parsePacket(); );
        var i = this.bits.byteLength - (this.bits.index >> 3);
        this.leftoverBytes =
          i > 0 ? this.bits.bytes.subarray(this.bits.index >> 3) : null;
      }),
      (t.parsePacket = function () {
        if (71 !== this.bits.read(8) && !this.resync()) return !1;
        var A = 187 + (this.bits.index >> 3);
        this.bits.read(1);
        var t = this.bits.read(1);
        this.bits.read(1);
        var i = this.bits.read(13);
        this.bits.read(2);
        var e = this.bits.read(2);
        this.bits.read(4);
        var s = this.pidsToStreamIds[i];
        if (t && s) {
        ...
        if (1 & e) {
          ...
          if (t && this.bits.nextBytesAreStartCode()) {
            ...
            this.bits.skip(6);
            var B = this.bits.read(8),
              C = this.bits.index + (B << 3),
          ...
          if (s) {
            ...
            if (c) {
              var l = this.bits.index >> 3,
                u = !t && 2 & e;
              (this.packetAddData(c, l, A) || (this.guessVideoFrameEnd && u)) &&
                this.packetComplete(c);
            }
          }
        }
      ...
      (t.resync = function () {
        ...
        for (var A = this.bits.index >> 3, t = 0; t < 187; t++)
          if (71 === this.bits.bytes[A + t]) {
            ...
            if (i) return (this.bits.index = (A + t + 1) << 3), !0;
          }
      ...
      return (
        ...
        (t.write = function (A, t) {
          this.collectTimestamps &&
            ...
            this.timestamps.push({ index: this.bytesWritten << 3, time: A })),
        ...
        (t.seek = function (A) {
          if (this.collectTimestamps) {
            ...
            for (
              var t = 0;
              t < this.timestamps.length && !(this.timestamps[t].time > A);
              t++
            )
              this.timestampIndex = t;
            var i = this.timestamps[this.timestampIndex];
            i
              ? (this.bufferSetIndex(i.index), (this.decodedTime = i.time))
        ...
        (t.advanceDecodedTime = function (A) {
          if (this.collectTimestamps) {
            for (
              var t = -1, i = this.bufferGetIndex(), e = this.timestampIndex;
              e < this.timestamps.length && !(this.timestamps[e].index > i);
              e++
            )
              t = e;
            if (-1 !== t && t !== this.timestampIndex)
              return (
                ...
                void (this.decodedTime =
                  this.timestamps[this.timestampIndex].time)
              );
          }
          this.decodedTime += A;
        }),
    ...
    w = (function (A) {
      function i(t) {
        ...
        var e = t.videoBufferSize || 524288,
          s = t.streaming ? c.MODE.EVICT : c.MODE.EXPAND;
        return (
          (i.bits = new c(e, s)),
      ...
      return (
        (e.write = function (A, t) {
          if ((u.prototype.write.call(this, A, t), !this.hasSequenceHeader)) {
            if (-1 === this.bits.findStartCode(i.START.SEQUENCE)) return !1;
        ...
        (e.decode = function () {
          ...
          if (-1 === this.bits.findStartCode(i.START.PICTURE)) return !1;
          this.decodePicture(), this.advanceDecodedTime(1 / this.frameRate);
          var t = Q() - A;
          return this.onDecodeCallback && this.onDecodeCallback(this, t), !0;
        }),
        ...
        (e.decodePicture = function () {
          if (
            ...
            for (; A >= i.START.SLICE_FIRST && A <= i.START.SLICE_LAST; )
              this.decodeSlice(255 & A), (A = this.bits.findNextStartCode());
            if (
              (-1 !== A && this.bits.rewind(32),
              this.destination &&
              ...
              this.pictureType === i.PICTURE_TYPE.INTRA ||
                this.pictureType === i.PICTURE_TYPE.PREDICTIVE)
            ) {
              var t = this.forwardY,
                e = this.forwardY32,
                s = this.forwardCr,
        ...
        (e.decodeMacroblock = function () {
          for (
            var A = 0, t = this.readHuffman(i.MACROBLOCK_ADDRESS_INCREMENT);
            34 === t;

          )
            t = this.readHuffman(i.MACROBLOCK_ADDRESS_INCREMENT);
          for (; 35 === t; )
            (A += 33), (t = this.readHuffman(i.MACROBLOCK_ADDRESS_INCREMENT));
          if (((A += t), this.sliceBegin))
            (this.sliceBegin = !1), (this.macroblockAddress += A);
          else {
          ...
          for (
            var s =
                0 != (2 & this.macroblockType)
                  ? this.readHuffman(i.CODE_BLOCK_PATTERN)
                  : this.macroblockIntra
                  ? 63
                  : 0,
              I = 0,
        ...
        (e.decodeMotionVectors = function () {
          ...
          this.macroblockMotFw
            ? (0 !== (A = this.readHuffman(i.MOTION)) && 1 !== this.forwardF
                ? ((e = this.bits.read(this.forwardRSize)),
        ...
        (e.copyMacroblock = function (A, t, i, e, s) {
          var I,
            ...
            R = this.currentCr32;
          if (
            ((o = (I = this.codedWidth) - 16),
            (g = A >> 1),
            (a = t >> 1),
            (B = 1 == (1 & A)),
            (C = 1 == (1 & t)),
            (Q = ((this.mbRow << 4) + a) * I + (this.mbCol << 4) + g),
            (r = (E = (this.mbRow * I + this.mbCol) << 2) + (I << 2)),
            B)
          )
            if (C)
              for (; E < r; ) {
                for (h = i[Q] + i[Q + I], Q++, n = 0; n < 4; n++)
          ...
          if (
            ((o = (I = this.halfWidth) - 8),
            (g = (A / 2) >> 1),
            (a = (t / 2) >> 1),
            (B = 1 == ((A / 2) & 1)),
            (C = 1 == ((t / 2) & 1)),
            (Q = ((this.mbRow << 3) + a) * I + (this.mbCol << 3) + g),
            ...
            if (C)
              for (; E < r; ) {
                for (
                  l = e[Q] + e[Q + I], D = s[Q] + s[Q + I], Q++, n = 0;
                  n < 2;
                  n++
                )
                  (w = ((l + (u = e[Q] + e[Q + I]) + 2) >> 2) & 255),
                    (f = ((D + (p = s[Q] + s[Q + I]) + 2) >> 2) & 255),
                    (w |= (((l = e[++Q] + e[Q + I]) + u + 2) << 6) & 65280),
                    (f |= (((D = s[Q] + s[Q + I]) + p + 2) << 6) & 65280),
                    (w |= ((l + (u = e[++Q] + e[Q + I]) + 2) << 14) & 16711680),
                    (f |= ((D + (p = s[Q] + s[Q + I]) + 2) << 14) & 16711680),
                    (l = e[++Q] + e[Q + I]),
                    (D = s[Q] + s[Q + I]),
                    Q++,
                    (w |= ((l + u + 2) << 22) & 4278190080),
                    (f |= ((D + p + 2) << 22) & 4278190080),
                    (R[E] = w),
                    (y[E] = f),
                    E++;
                (E += o >> 2), (Q += o - 1);
              ...
              for (; E < r; ) {
                for (l = e[Q], D = s[Q], Q++, n = 0; n < 2; n++)
                  (w = ((l + (u = e[Q]) + 1) >> 1) & 255),
                    (f = ((D + (p = s[Q++]) + 1) >> 1) & 255),
                    (w |= (((l = e[Q]) + u + 1) << 7) & 65280),
                    (f |= (((D = s[Q++]) + p + 1) << 7) & 65280),
                    (w |= ((l + (u = e[Q]) + 1) << 15) & 16711680),
                    (f |= ((D + (p = s[Q++]) + 1) << 15) & 16711680),
                    (w |= (((l = e[Q]) + u + 1) << 23) & 4278190080),
                    (f |= (((D = s[Q++]) + p + 1) << 23) & 4278190080),
                    (R[E] = w),
                    (y[E] = f),
                    E++;
                (E += o >> 2), (Q += o - 1);
            ...
            for (; E < r; ) {
              for (n = 0; n < 2; n++)
                (w = ((e[Q] + e[Q + I] + 1) >> 1) & 255),
                  (f = ((s[Q] + s[Q + I] + 1) >> 1) & 255),
                  (w |= ((e[++Q] + e[Q + I] + 1) << 7) & 65280),
                  (f |= ((s[Q] + s[Q + I] + 1) << 7) & 65280),
                  (w |= ((e[++Q] + e[Q + I] + 1) << 15) & 16711680),
                  (f |= ((s[Q] + s[Q + I] + 1) << 15) & 16711680),
                  (w |= ((e[++Q] + e[Q + I] + 1) << 23) & 4278190080),
        ...
        (e.decodeBlock = function (A) {
          ...
          if (this.macroblockIntra) {
            ...
            if (
              (A < 4
                ? ((s = this.dcPredictorY),
                  (I = this.readHuffman(i.DCT_DC_SIZE_LUMINANCE)))
                : ((s = 4 === A ? this.dcPredictorCr : this.dcPredictorCb),
                  (I = this.readHuffman(i.DCT_DC_SIZE_CHROMINANCE))),
              I > 0)
            ) {
              var o = this.bits.read(I);
              this.blockData[0] =
                0 != (o & (1 << (I - 1))) ? s + o : s + ((-1 << I) | (o + 1));
          ...
          for (var g, a, B, C = 0; ; ) {
            var Q = 0,
              r = this.readHuffman(i.DCT_COEFF);
            if (1 === r && e > 0 && 0 === this.bits.read(1)) break;
            65535 === r
              ? ((Q = this.bits.read(6)),
                0 === (C = this.bits.read(8))
                  ? (C = this.bits.read(8))
                  : 128 === C
                  ? (C = this.bits.read(8) - 256)
                  : C > 128 && (C -= 256))
              : ((Q = r >> 8), (C = 255 & r), this.bits.read(1) && (C = -C)),
              (e += Q);
            var n = i.ZIG_ZAG[e];
            e++,
              (C <<= 1),
              this.macroblockIntra || (C += C < 0 ? -1 : 1),
              0 == (1 & (C = (C * this.quantizerScale * t[n]) >> 4)) &&
                (C -= C > 0 ? 1 : -1),
              C > 2047 ? (C = 2047) : C < -2048 && (C = -2048),
              (this.blockData[n] = C * i.PREMULTIPLIER_MATRIX[n]);
          }
          A < 4
            ? ((g = this.currentY),
              (B = this.codedWidth - 8),
              (a = (this.mbRow * this.codedWidth + this.mbCol) << 4),
              0 != (1 & A) && (a += 8),
              0 != (2 & A) && (a += this.codedWidth << 3))
            : ((g = 4 === A ? this.currentCb : this.currentCr),
              (B = (this.codedWidth >> 1) - 8),
              (a = ((this.mbRow * this.codedWidth) << 2) + (this.mbCol << 3))),
            this.macroblockIntra
              ? 1 === e
                ? (i.CopyValueToDestination(
                  ...
                  (this.blockData[0] = 0))
                : (i.IDCT(this.blockData),
                  i.CopyBlockToDestination(this.blockData, g, a, B),
                  E(this.blockData, 0))
              : 1 === e
              ? (i.AddValueToDestination(
                  (this.blockData[0] + 128) >> 8,
                  g,
                  a,
                  B
                ...
                (this.blockData[0] = 0))
              : (i.IDCT(this.blockData),
                i.AddBlockToDestination(this.blockData, g, a, B),
                E(this.blockData, 0)),
            (e = 0);
        }),
        (i.CopyBlockToDestination = function (A, t, i, e) {
          for (var s = 0; s < 64; s += 8, i += e + 8)
            (t[i + 0] = A[s + 0]),
              (t[i + 1] = A[s + 1]),
              (t[i + 2] = A[s + 2]),
              (t[i + 3] = A[s + 3]),
        ...
        (i.IDCT = function (A) {
          for (
            var t, i, e, s, I, o, g, a, B, C, Q, E, r, n, h, d, c, l, u = 0;
            u < 8;
            ++u
          )
            (t = A[32 + u]),
              ...
              (B =
                (r =
                  ((473 * (s = A[8 + u] - A[56 + u]) - 196 * e + 128) >> 8) -
                  (I = o + g)) -
                ((362 * (o - g) + 128) >> 8)),
              (n =
                (C = (a = A[0 + u]) - t) +
                (Q = ((362 * (A[16 + u] - A[48 + u]) + 128) >> 8) - i)),
              (h = (E = a + t) + i),
              (d = C - Q),
              (c = E - i),
              (l = -B - ((473 * e + 196 * s + 128) >> 8)),
              (A[0 + u] = I + h),
              (A[8 + u] = r + n),
              (A[16 + u] = d - B),
              (A[24 + u] = c - l),
          ...
          for (var w = 0; w < 64; w += 8)
            (t = A[4 + w]),
              ...
              (B =
                (r =
                  ((473 * (s = A[1 + w] - A[7 + w]) - 196 * e + 128) >> 8) -
                  (I = o + g)) -
                ((362 * (o - g) + 128) >> 8)),
              (n =
                (C = (a = A[0 + w]) - t) +
                (Q = ((362 * (A[2 + w] - A[6 + w]) + 128) >> 8) - i)),
              (h = (E = a + t) + i),
              (d = C - Q),
              (c = E - i),
              (l = -B - ((473 * e + 196 * s + 128) >> 8)),
  ...
  (w.prototype.frameRate = 30),
    (w.prototype.currentY = null),
    (w.prototype.currentCr = null),
    (w.prototype.currentCb = null),
    (w.prototype.pictureType = 0),
    (w.prototype.forwardY = null),
    (w.prototype.forwardCr = null),
    (w.prototype.forwardCb = null),
    (w.prototype.fullPelForward = !1),
    (w.prototype.forwardFCode = 0),
    (w.prototype.forwardRSize = 0),
    (w.prototype.forwardF = 0),
    (w.prototype.quantizerScale = 0),
    (w.prototype.sliceBegin = !1),
    (w.prototype.macroblockAddress = 0),
    (w.prototype.mbRow = 0),
    (w.prototype.mbCol = 0),
    (w.prototype.macroblockType = 0),
    (w.prototype.macroblockIntra = !1),
    (w.prototype.macroblockMotFw = !1),
    (w.prototype.motionFwH = 0),
    (w.prototype.motionFwV = 0),
    (w.prototype.motionFwHPrev = 0),
    (w.prototype.motionFwVPrev = 0),
    (w.prototype.dcPredictorY = 0),
    (w.prototype.dcPredictorCr = 0),
    (w.prototype.dcPredictorCb = 0),
    (w.prototype.blockData = null),
    (w.PICTURE_RATE = [
      0, 23.976, 24, 25, 29.97, 30, 50, 59.94, 60, 0, 0, 0, 0, 0, 0, 0,
    ]),
    (w.ZIG_ZAG = new Uint8Array([
    ...
    (w.DEFAULT_INTRA_QUANT_MATRIX = new Uint8Array([
    ...
    (w.DEFAULT_NON_INTRA_QUANT_MATRIX = new Uint8Array([
      16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16,
      16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16,
      16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16,
      16, 16, 16, 16, 16, 16, 16, 16, 16, 16,
    ])),
    (w.PREMULTIPLIER_MATRIX = new Uint8Array([
    ...
    (w.MACROBLOCK_ADDRESS_INCREMENT = new Int16Array([
      3, 6, 0, 9, 12, 0, 0, 0, 1, 15, 18, 0, 21, 24, 0, 27, 30, 0, 33, 36, 0, 0,
      0, 3, 0, 0, 2, 39, 42, 0, 45, 48, 0, 0, 0, 5, 0, 0, 4, 51, 54, 0, 57, 60,
      0, 0, 0, 7, 0, 0, 6, 63, 66, 0, 69, 72, 0, 75, 78, 0, 81, 84, 0, -1, 87,
      0, -1, 90, 0, 93, 96, 0, 99, 102, 0, 105, 108, 0, 111, 114, 0, 0, 0, 9, 0,
      0, 8, 117, 120, 0, 123, 126, 0, 129, 132, 0, 135, 138, 0, 0, 0, 15, 0, 0,
      14, 0, 0, 13, 0, 0, 12, 0, 0, 11, 0, 0, 10, 141, -1, 0, -1, 144, 0, 147,
      150, 0, 153, 156, 0, 159, 162, 0, 165, 168, 0, 171, 174, 0, 177, 180, 0,
      183, -1, 0, -1, 186, 0, 189, 192, 0, 195, 198, 0, 201, 204, 0, 207, 210,
      0, 213, 216, 0, 219, 222, 0, 0, 0, 21, 0, 0, 20, 0, 0, 19, 0, 0, 18, 0, 0,
      17, 0, 0, 16, 0, 0, 35, 0, 0, 34, 0, 0, 33, 0, 0, 32, 0, 0, 31, 0, 0, 30,
      0, 0, 29, 0, 0, 28, 0, 0, 27, 0, 0, 26, 0, 0, 25, 0, 0, 24, 0, 0, 23, 0,
      0, 22,
    ])),
    (w.MACROBLOCK_TYPE_INTRA = new Int8Array([
      3, 6, 0, -1, 9, 0, 0, 0, 1, 0, 0, 17,
    ])),
    (w.MACROBLOCK_TYPE_PREDICTIVE = new Int8Array([
      3, 6, 0, 9, 12, 0, 0, 0, 10, 15, 18, 0, 0, 0, 2, 21, 24, 0, 0, 0, 8, 27,
      30, 0, 33, 36, 0, -1, 39, 0, 0, 0, 18, 0, 0, 26, 0, 0, 1, 0, 0, 17,
    ])),
    (w.MACROBLOCK_TYPE_B = new Int8Array([
      3, 6, 0, 9, 15, 0, 12, 18, 0, 24, 21, 0, 0, 0, 12, 27, 30, 0, 0, 0, 14,
      39, 42, 0, 36, 33, 0, 0, 0, 4, 0, 0, 6, 54, 48, 0, 45, 51, 0, 0, 0, 8, 0,
      0, 10, -1, 57, 0, 0, 0, 1, 60, 63, 0, 0, 0, 30, 0, 0, 17, 0, 0, 22, 0, 0,
      26,
    ])),
    (w.MACROBLOCK_TYPE = [
      null,
      w.MACROBLOCK_TYPE_INTRA,
      w.MACROBLOCK_TYPE_PREDICTIVE,
      w.MACROBLOCK_TYPE_B,
    ]),
    (w.CODE_BLOCK_PATTERN = new Int16Array([
      6, 3, 0, 9, 18, 0, 12, 15, 0, 24, 33, 0, 36, 39, 0, 27, 21, 0, 30, 42, 0,
      60, 57, 0, 54, 48, 0, 69, 51, 0, 81, 75, 0, 63, 84, 0, 45, 66, 0, 72, 78,
      0, 0, 0, 60, 105, 120, 0, 132, 144, 0, 114, 108, 0, 126, 141, 0, 87, 93,
      0, 117, 96, 0, 0, 0, 32, 135, 138, 0, 99, 123, 0, 129, 102, 0, 0, 0, 4,
      90, 111, 0, 0, 0, 8, 0, 0, 16, 0, 0, 44, 150, 168, 0, 0, 0, 28, 0, 0, 52,
      0, 0, 62, 183, 177, 0, 156, 180, 0, 0, 0, 1, 165, 162, 0, 0, 0, 61, 0, 0,
      56, 171, 174, 0, 0, 0, 2, 0, 0, 40, 153, 186, 0, 0, 0, 48, 192, 189, 0,
      147, 159, 0, 0, 0, 20, 0, 0, 12, 240, 249, 0, 0, 0, 63, 231, 225, 0, 195,
      219, 0, 252, 198, 0, 0, 0, 24, 0, 0, 36, 0, 0, 3, 207, 261, 0, 243, 237,
      0, 204, 213, 0, 210, 234, 0, 201, 228, 0, 216, 222, 0, 258, 255, 0, 264,
      246, 0, -1, 282, 0, 285, 291, 0, 0, 0, 33, 0, 0, 9, 318, 330, 0, 306, 348,
      0, 0, 0, 5, 0, 0, 10, 279, 267, 0, 0, 0, 6, 0, 0, 18, 0, 0, 17, 0, 0, 34,
      339, 357, 0, 309, 312, 0, 270, 276, 0, 327, 321, 0, 351, 354, 0, 303, 297,
      0, 294, 288, 0, 300, 273, 0, 342, 345, 0, 315, 324, 0, 336, 333, 0, 363,
      375, 0, 0, 0, 41, 0, 0, 14, 0, 0, 21, 372, 366, 0, 360, 369, 0, 0, 0, 11,
      0, 0, 19, 0, 0, 7, 0, 0, 35, 0, 0, 13, 0, 0, 50, 0, 0, 49, 0, 0, 58, 0, 0,
      37, 0, 0, 25, 0, 0, 45, 0, 0, 57, 0, 0, 26, 0, 0, 29, 0, 0, 38, 0, 0, 53,
      0, 0, 23, 0, 0, 43, 0, 0, 46, 0, 0, 42, 0, 0, 22, 0, 0, 54, 0, 0, 51, 0,
      0, 15, 0, 0, 30, 0, 0, 39, 0, 0, 47, 0, 0, 55, 0, 0, 27, 0, 0, 59, 0, 0,
      31,
    ])),
    (w.MOTION = new Int16Array([
      3, 6, 0, 12, 9, 0, 0, 0, 0, 18, 15, 0, 24, 21, 0, 0, 0, -1, 0, 0, 1, 27,
      30, 0, 36, 33, 0, 0, 0, 2, 0, 0, -2, 42, 45, 0, 48, 39, 0, 60, 54, 0, 0,
      0, 3, 0, 0, -3, 51, 57, 0, -1, 69, 0, 81, 75, 0, 78, 63, 0, 72, 66, 0, 96,
      84, 0, 87, 93, 0, -1, 99, 0, 108, 105, 0, 0, 0, -4, 90, 102, 0, 0, 0, 4,
      0, 0, -7, 0, 0, 5, 111, 123, 0, 0, 0, -5, 0, 0, 7, 114, 120, 0, 126, 117,
      0, 0, 0, -6, 0, 0, 6, 153, 162, 0, 150, 147, 0, 135, 138, 0, 156, 141, 0,
      129, 159, 0, 132, 144, 0, 0, 0, 10, 0, 0, 9, 0, 0, 8, 0, 0, -8, 171, 198,
      0, 0, 0, -9, 180, 192, 0, 168, 183, 0, 165, 186, 0, 174, 189, 0, 0, 0,
      -10, 177, 195, 0, 0, 0, 12, 0, 0, 16, 0, 0, 13, 0, 0, 14, 0, 0, 11, 0, 0,
      15, 0, 0, -16, 0, 0, -12, 0, 0, -14, 0, 0, -15, 0, 0, -11, 0, 0, -13,
    ])),
    (w.DCT_DC_SIZE_LUMINANCE = new Int8Array([
      6, 3, 0, 18, 15, 0, 9, 12, 0, 0, 0, 1, 0, 0, 2, 27, 24, 0, 21, 30, 0, 0,
      0, 0, 36, 33, 0, 0, 0, 4, 0, 0, 3, 39, 42, 0, 0, 0, 5, 0, 0, 6, 48, 45, 0,
      51, -1, 0, 0, 0, 7, 0, 0, 8,
    ])),
    (w.DCT_DC_SIZE_CHROMINANCE = new Int8Array([
      6, 3, 0, 12, 9, 0, 18, 15, 0, 24, 21, 0, 0, 0, 2, 0, 0, 1, 0, 0, 0, 30,
      27, 0, 0, 0, 3, 36, 33, 0, 0, 0, 4, 42, 39, 0, 0, 0, 5, 48, 45, 0, 0, 0,
      6, 51, -1, 0, 0, 0, 7, 0, 0, 8,
    ])),
    (w.DCT_COEFF = new Int32Array([
      3, 6, 0, 12, 9, 0, 0, 0, 1, 21, 24, 0, 18, 15, 0, 39, 27, 0, 33, 30, 0,
      42, 36, 0, 0, 0, 257, 60, 66, 0, 54, 63, 0, 48, 57, 0, 0, 0, 513, 51, 45,
      0, 0, 0, 2, 0, 0, 3, 81, 75, 0, 87, 93, 0, 72, 78, 0, 96, 90, 0, 0, 0,
      1025, 69, 84, 0, 0, 0, 769, 0, 0, 258, 0, 0, 1793, 0, 0, 65535, 0, 0,
      1537, 111, 108, 0, 0, 0, 1281, 105, 102, 0, 117, 114, 0, 99, 126, 0, 120,
      123, 0, 156, 150, 0, 162, 159, 0, 144, 147, 0, 129, 135, 0, 138, 132, 0,
      0, 0, 2049, 0, 0, 4, 0, 0, 514, 0, 0, 2305, 153, 141, 0, 165, 171, 0, 180,
      168, 0, 177, 174, 0, 183, 186, 0, 0, 0, 2561, 0, 0, 3329, 0, 0, 6, 0, 0,
      259, 0, 0, 5, 0, 0, 770, 0, 0, 2817, 0, 0, 3073, 228, 225, 0, 201, 210, 0,
      219, 213, 0, 234, 222, 0, 216, 231, 0, 207, 192, 0, 204, 189, 0, 198, 195,
      0, 243, 261, 0, 273, 240, 0, 246, 237, 0, 249, 258, 0, 279, 276, 0, 252,
      255, 0, 270, 282, 0, 264, 267, 0, 0, 0, 515, 0, 0, 260, 0, 0, 7, 0, 0,
      1026, 0, 0, 1282, 0, 0, 4097, 0, 0, 3841, 0, 0, 3585, 315, 321, 0, 333,
      342, 0, 312, 291, 0, 375, 357, 0, 288, 294, 0, -1, 369, 0, 285, 303, 0,
      318, 363, 0, 297, 306, 0, 339, 309, 0, 336, 348, 0, 330, 300, 0, 372, 345,
      0, 351, 366, 0, 327, 354, 0, 360, 324, 0, 381, 408, 0, 417, 420, 0, 390,
      378, 0, 435, 438, 0, 384, 387, 0, 0, 0, 2050, 396, 402, 0, 465, 462, 0, 0,
      0, 8, 411, 399, 0, 429, 432, 0, 453, 414, 0, 426, 423, 0, 0, 0, 10, 0, 0,
      9, 0, 0, 11, 0, 0, 5377, 0, 0, 1538, 0, 0, 771, 0, 0, 5121, 0, 0, 1794, 0,
      0, 4353, 0, 0, 4609, 0, 0, 4865, 444, 456, 0, 0, 0, 1027, 459, 450, 0, 0,
      0, 261, 393, 405, 0, 0, 0, 516, 447, 441, 0, 516, 519, 0, 486, 474, 0,
      510, 483, 0, 504, 498, 0, 471, 537, 0, 507, 501, 0, 522, 513, 0, 534, 531,
      0, 468, 477, 0, 492, 495, 0, 549, 546, 0, 525, 528, 0, 0, 0, 263, 0, 0,
      2562, 0, 0, 2306, 0, 0, 5633, 0, 0, 5889, 0, 0, 6401, 0, 0, 6145, 0, 0,
      1283, 0, 0, 772, 0, 0, 13, 0, 0, 12, 0, 0, 14, 0, 0, 15, 0, 0, 517, 0, 0,
      6657, 0, 0, 262, 540, 543, 0, 480, 489, 0, 588, 597, 0, 0, 0, 27, 609,
      555, 0, 606, 603, 0, 0, 0, 19, 0, 0, 22, 591, 621, 0, 0, 0, 18, 573, 576,
      0, 564, 570, 0, 0, 0, 20, 552, 582, 0, 0, 0, 21, 558, 579, 0, 0, 0, 23,
      612, 594, 0, 0, 0, 25, 0, 0, 24, 600, 615, 0, 0, 0, 31, 0, 0, 30, 0, 0,
      28, 0, 0, 29, 0, 0, 26, 0, 0, 17, 0, 0, 16, 567, 618, 0, 561, 585, 0, 654,
      633, 0, 0, 0, 37, 645, 648, 0, 0, 0, 36, 630, 636, 0, 0, 0, 34, 639, 627,
      0, 663, 666, 0, 657, 624, 0, 651, 642, 0, 669, 660, 0, 0, 0, 35, 0, 0,
      267, 0, 0, 40, 0, 0, 268, 0, 0, 266, 0, 0, 32, 0, 0, 264, 0, 0, 265, 0, 0,
      38, 0, 0, 269, 0, 0, 270, 0, 0, 33, 0, 0, 39, 0, 0, 7937, 0, 0, 6913, 0,
      0, 7681, 0, 0, 4098, 0, 0, 7425, 0, 0, 7169, 0, 0, 271, 0, 0, 274, 0, 0,
      273, 0, 0, 272, 0, 0, 1539, 0, 0, 2818, 0, 0, 3586, 0, 0, 3330, 0, 0,
      3074, 0, 0, 3842,
    ])),
    (w.PICTURE_TYPE = { INTRA: 1, PREDICTIVE: 2, B: 3 }),
    (w.START = {
      SEQUENCE: 179,
      SLICE_FIRST: 1,
      SLICE_LAST: 175,
  ...
  var D = (function (A) {
      function i(t) {
        ...
        return (
          ...
          (i.bufferMode = t.streaming ? c.MODE.EVICT : c.MODE.EXPAND),
          (i.decodeFirstFrame = !1 !== t.decodeFirstFrame),
      ...
      var e = i.prototype;
      return (
        (e.initializeWasmDecoder = function () {
        ...
        (e.bufferSetIndex = function (A) {
          this.decoder &&
            this.functions._mpeg1_decoder_set_index(this.decoder, A);
        }),
        (e.bufferWrite = function (A) {
          ...
          for (
            ...
            this.instance.heapU8.set(A[s], e), (e += A[s].length);
          return this.functions._mpeg1_decoder_did_write(this.decoder, t), t;
        }),
        (e.write = function (A, t) {
          u.prototype.write.call(this, A, t),
            !this.hasSequenceHeader &&
              this.functions._mpeg1_decoder_has_sequence_header(this.decoder) &&
              this.loadSequenceHeader();
        }),
        (e.loadSequenceHeader = function () {
          if (
            ((this.hasSequenceHeader = !0),
        ...
        (e.decode = function () {
          ...
          if (!this.functions._mpeg1_decoder_decode(this.decoder)) return !1;
          if (this.destination) {
            var t = this.functions._mpeg1_decoder_get_y_ptr(this.decoder),
              ...
              o = this.instance.heapU8.subarray(e, e + (this.codedSize >> 2));
            this.destination.render(s, I, o, !1);
          }
          this.advanceDecodedTime(1 / this.frameRate);
          var g = Q() - A;
          return this.onDecodeCallback && this.onDecodeCallback(this, g), !0;
        }),
        i
      );
    })(u),
    p = (function (A) {
      function i(t) {
        ...
        var s = t.audioBufferSize || 131072,
          I = t.streaming ? c.MODE.EVICT : c.MODE.EXPAND;
        (e.bits = new c(s, I)),
        ...
        for (var o = 0; o < 2; o++)
          for (var g = 0; g < 32; g++)
            (e.scaleFactor[o][g] = [0, 0, 0]), (e.sample[o][g] = [0, 0, 0]);
        return e;
      }
      t(i, A);
      var e = i.prototype;
      return (
        (e.decode = function () {
          ...
          var e = Q() - A;
          return this.onDecodeCallback && this.onDecodeCallback(this, e), !0;
        }),
        ...
        (e.decodeFrame = function (A, t) {
          ...
          if (e !== i.FRAME_SYNC || s !== i.VERSION.MPEG_1 || I !== i.LAYER.II)
            return 0;
          var g = this.bits.read(4) - 1;
          if (g > 13) return 0;
          var a = this.bits.read(2),
            B = i.SAMPLE_RATE[a];
          if (3 === a) return 0;
          s === i.VERSION.MPEG_2 && ((a += 4), (g += 14));
          var C = this.bits.read(1);
          this.bits.read(1);
          var Q = this.bits.read(2),
            r = 0;
          Q === i.MODE.JOINT_STEREO
            ? (r = (this.bits.read(2) + 1) << 2)
            : (this.bits.skip(2), (r = Q === i.MODE.MONO ? 0 : 32)),
            this.bits.skip(4),
            o && this.bits.skip(16);
          var n = ((144e3 * i.BIT_RATE[g]) / (B = i.SAMPLE_RATE[a]) + C) | 0,
            h = 0,
            d = 0;
          if (s === i.VERSION.MPEG_2) (h = 2), (d = 30);
          else {
            var c = Q === i.MODE.MONO ? 0 : 1,
              l = i.QUANT_LUT_STEP_1[c][g];
            (d = 63 & (h = i.QUANT_LUT_STEP_2[l][a])), (h >>= 6);
          }
          r > d && (r = d);
          for (var u = 0; u < r; u++)
          ...
          for (var w = r; w < d; w++)
            this.allocation[0][w] = this.allocation[1][w] = this.readAllocation(
              w,
              h
            );
          for (var D = Q === i.MODE.MONO ? 1 : 2, p = 0; p < d; p++) {
            for (var f = 0; f < D; f++)
              this.allocation[f][p] &&
                (this.scaleFactorInfo[f][p] = this.bits.read(2));
            Q === i.MODE.MONO &&
              (this.scaleFactorInfo[1][p] = this.scaleFactorInfo[0][p]);
          }
          for (var m = 0; m < d; m++) {
            for (var y = 0; y < D; y++)
            ...
            Q === i.MODE.MONO &&
              ((this.scaleFactor[1][m][0] = this.scaleFactor[0][m][0]),
              (this.scaleFactor[1][m][1] = this.scaleFactor[0][m][1]),
              (this.scaleFactor[1][m][2] = this.scaleFactor[0][m][2]));
          }
          for (var k = 0, b = 0; b < 3; b++)
            for (var G = 0; G < 4; G++) {
              for (var F = 0; F < r; F++)
                this.readSamples(0, F, b), this.readSamples(1, F, b);
              for (var S = r; S < d; S++)
                this.readSamples(0, S, b),
                  (this.sample[1][S][0] = this.sample[0][S][0]),
                  (this.sample[1][S][1] = this.sample[0][S][1]),
                  (this.sample[1][S][2] = this.sample[0][S][2]);
              for (var M = d; M < 32; M++)
                (this.sample[0][M][0] = 0),
                  (this.sample[0][M][1] = 0),
                  (this.sample[0][M][2] = 0),
              ...
              for (var q = 0; q < 3; q++) {
                ...
                for (var N = 0; N < 2; N++) {
                  i.MatrixTransform(this.sample[N], q, this.V[N], this.VPos),
                    E(this.U, 0);
                  for (
                    var L = 512 - (this.VPos >> 1), U = this.VPos % 128 >> 1;
                    U < 1024;

                  ) {
                    for (var J = 0; J < 32; ++J)
                      this.U[J] += this.D[L++] * this.V[N][U++];
                    (U += 96), (L += 32);
                  }
                  for (U = 1120 - U, L -= 480; U < 1024; ) {
                    for (var T = 0; T < 32; ++T)
                      this.U[T] += this.D[L++] * this.V[N][U++];
                    (U += 96), (L += 32);
                  }
                  for (var v = 0 === N ? A : t, x = 0; x < 32; x++)
                    v[k + x] = this.U[x] / 2147418112;
                }
                k += 32;
              }
            }
          return (this.sampleRate = B), n;
        }),
        ...
        (e.readSamples = function (A, t, e) {
          ...
          if (s) {
            if (63 === I) I = 0;
              ...
              var a = (I / 3) | 0;
              I = (i.SCALEFACTOR_BASE[I % 3] + ((1 << a) >> 1)) >> a;
            }
            var B = s.levels;
            s.group
              ? ((g = this.bits.read(s.bits)),
                (o[0] = g % B),
                (g = (g / B) | 0),
                (o[1] = g % B),
                (o[2] = (g / B) | 0))
              : ((o[0] = this.bits.read(s.bits)),
                (o[1] = this.bits.read(s.bits)),
                (o[2] = this.bits.read(s.bits)));
            var C = (65536 / (B + 1)) | 0;
            (g = ((B = ((B + 1) >> 1) - 1) - o[0]) * C),
              (o[0] = (g * (I >> 12) + ((g * (4095 & I) + 2048) >> 12)) >> 12),
              (g = (B - o[1]) * C),
              (o[1] = (g * (I >> 12) + ((g * (4095 & I) + 2048) >> 12)) >> 12),
              (g = (B - o[2]) * C),
              (o[2] = (g * (I >> 12) + ((g * (4095 & I) + 2048) >> 12)) >> 12);
          } else o[0] = o[1] = o[2] = 0;
        }),
        (i.MatrixTransform = function (A, t, i, e) {
          var s,
            ...
            U;
          (s = A[0][t] + A[31][t]),
            (I = 0.500602998235 * (A[0][t] - A[31][t])),
            (o = A[1][t] + A[30][t]),
            (g = 0.505470959898 * (A[1][t] - A[30][t])),
            (a = A[2][t] + A[29][t]),
            (B = 0.515447309923 * (A[2][t] - A[29][t])),
            (C = A[3][t] + A[28][t]),
            (Q = 0.53104259109 * (A[3][t] - A[28][t])),
            (E = A[4][t] + A[27][t]),
            (r = 0.553103896034 * (A[4][t] - A[27][t])),
            (n = A[5][t] + A[26][t]),
            (h = 0.582934968206 * (A[5][t] - A[26][t])),
            (d = A[6][t] + A[25][t]),
            (c = 0.622504123036 * (A[6][t] - A[25][t])),
            (l = A[7][t] + A[24][t]),
            (u = 0.674808341455 * (A[7][t] - A[24][t])),
            (w = A[8][t] + A[23][t]),
            (D = 0.744536271002 * (A[8][t] - A[23][t])),
            (p = A[9][t] + A[22][t]),
            (f = 0.839349645416 * (A[9][t] - A[22][t])),
            (m = A[10][t] + A[21][t]),
            (y = 0.972568237862 * (A[10][t] - A[21][t])),
            (R = A[11][t] + A[20][t]),
            (k = 1.16943993343 * (A[11][t] - A[20][t])),
            (b = A[12][t] + A[19][t]),
            (G = 1.48416461631 * (A[12][t] - A[19][t])),
            (F = A[13][t] + A[18][t]),
            (S = 2.05778100995 * (A[13][t] - A[18][t])),
            (M = A[14][t] + A[17][t]),
            (q = 3.40760841847 * (A[14][t] - A[17][t])),
            (U = s + (N = A[15][t] + A[16][t])),
            (N = 0.502419286188 * (s - N)),
            (s = o + M),
            (M = 0.52249861494 * (o - M)),
            (o = a + F),
            (F = 0.566944034816 * (a - F)),
            (a = C + b),
            (b = 0.64682178336 * (C - b)),
            (C = E + R),
            (R = 0.788154623451 * (E - R)),
            (E = n + m),
            (m = 1.06067768599 * (n - m)),
            (n = d + p),
            (p = 1.72244709824 * (d - p)),
            ...
            (w = 5.10114861869 * (l - w)),
            (l = U + d),
            (d = 0.509795579104 * (U - d)),
            (U = s + n),
            (s = 0.601344886935 * (s - n)),
            (n = o + E),
            (E = 0.899976223136 * (o - E)),
            (o = a + C),
            (C = 2.56291544774 * (a - C)),
            (a = l + o),
            (l = 0.541196100146 * (l - o)),
            (o = U + n),
            (n = 1.30656296488 * (U - n)),
            (U = a + o),
            (a = 0.707106781187 * (a - o)),
            (o = l + n),
            (o += l = 0.707106781187 * (l - n)),
            (n = d + C),
            (d = 0.541196100146 * (d - C)),
            (C = s + E),
            (E = 1.30656296488 * (s - E)),
            (s = n + C),
            (C = 0.707106781187 * (n - C)),
            (n = d + E),
            (s += n += d = 0.707106781187 * (d - E)),
            (n += C),
            (C += d),
            (E = N + w),
            (N = 0.509795579104 * (N - w)),
            (w = M + p),
            (M = 0.601344886935 * (M - p)),
            (p = F + m),
            (m = 0.899976223136 * (F - m)),
            (F = b + R),
            (R = 2.56291544774 * (b - R)),
            (b = E + F),
            (E = 0.541196100146 * (E - F)),
            (F = w + p),
            (p = 1.30656296488 * (w - p)),
            (w = b + F),
            (F = 0.707106781187 * (b - F)),
            (b = E + p),
            (p = 0.707106781187 * (E - p)),
            (E = N + R),
            (N = 0.541196100146 * (N - R)),
            (R = M + m),
            (m = 1.30656296488 * (M - m)),
            (M = E + R),
            (R = 0.707106781187 * (E - R)),
            (E = N + m),
            (w += M += E += N = 0.707106781187 * (N - m)),
            (M += b += p),
            (b += E += R),
            (E += F),
            (F += R += N),
            ...
            (I = 0.502419286188 * (I - L)),
            (L = g + q),
            (g = 0.52249861494 * (g - q)),
            (q = B + S),
            (S = 0.566944034816 * (B - S)),
            (B = Q + G),
            (Q = 0.64682178336 * (Q - G)),
            (G = r + k),
            (r = 0.788154623451 * (r - k)),
            (k = h + y),
            (y = 1.06067768599 * (h - y)),
            (h = c + f),
            (f = 1.72244709824 * (c - f)),
            ...
            (u = 5.10114861869 * (u - D)),
            (D = m + c),
            (c = 0.509795579104 * (m - c)),
            (m = L + h),
            (L = 0.601344886935 * (L - h)),
            (h = q + k),
            (k = 0.899976223136 * (q - k)),
            (q = B + G),
            (G = 2.56291544774 * (B - G)),
            (B = D + q),
            ...
            (h = 1.30656296488 * (m - h)),
            (m = B + q),
            (q = 0.707106781187 * (B - q)),
            (B = D + h),
            (h = 0.707106781187 * (D - h)),
            (D = c + G),
            (G = 0.541196100146 * (c - G)),
            (c = L + k),
            (k = 1.30656296488 * (L - k)),
            (L = D + c),
            (c = 0.707106781187 * (D - c)),
            (D = G + k),
            (L += D += k = 0.707106781187 * (G - k)),
            (D += c),
            (G = c + k),
            (c = I + u),
            (I = 0.509795579104 * (I - u)),
            (u = g + f),
            (g = 0.601344886935 * (g - f)),
            (f = S + y),
            (y = 0.899976223136 * (S - y)),
            (S = Q + r),
            (r = 2.56291544774 * (Q - r)),
            (Q = c + S),
            (c = 0.541196100146 * (c - S)),
            (S = u + f),
            (f = 1.30656296488 * (u - f)),
            (u = Q + S),
            (S = 0.707106781187 * (Q - S)),
            (Q = c + f),
            (f = 0.707106781187 * (c - f)),
            (c = I + r),
            (I = 0.541196100146 * (I - r)),
            (r = g + y),
            (y = 1.30656296488 * (g - y)),
            (g = c + r),
            (r = 0.707106781187 * (c - r)),
            (c = I + y),
            (m += u += g += c += I = 0.707106781187 * (I - y)),
            (u += L),
            (L += g += Q += f),
            (g += B += h),
            (B += Q += c += r),
  ...
  (p.FRAME_SYNC = 2047),
    (p.VERSION = { MPEG_2_5: 0, MPEG_2: 2, MPEG_1: 3 }),
    (p.LAYER = { III: 1, II: 2, I: 3 }),
    (p.MODE = { STEREO: 0, JOINT_STEREO: 1, DUAL_CHANNEL: 2, MONO: 3 }),
    (p.SAMPLE_RATE = new Uint16Array([
      44100, 48e3, 32e3, 0, 22050, 24e3, 16e3, 0,
    ])),
    (p.BIT_RATE = new Uint16Array([
      32, 48, 56, 64, 80, 96, 112, 128, 160, 192, 224, 256, 320, 384, 8, 16, 24,
      32, 40, 48, 56, 64, 80, 96, 112, 128, 144, 160,
    ])),
    (p.SCALEFACTOR_BASE = new Uint32Array([33554432, 26632170, 21137968])),
    (p.SYNTHESIS_WINDOW = new Float32Array([
      0, -0.5, -0.5, -0.5, -0.5, -0.5, -0.5, -1, -1, -1, -1, -1.5, -1.5, -2, -2,
      -2.5, -2.5, -3, -3.5, -3.5, -4, -4.5, -5, -5.5, -6.5, -7, -8, -8.5, -9.5,
      -10.5, -12, -13, -14.5, -15.5, -17.5, -19, -20.5, -22.5, -24.5, -26.5,
      -29, -31.5, -34, -36.5, -39.5, -42.5, -45.5, -48.5, -52, -55.5, -58.5,
      -62.5, -66, -69.5, -73.5, -77, -80.5, -84.5, -88, -91.5, -95, -98, -101,
      -104, 106.5, 109, 111, 112.5, 113.5, 114, 114, 113.5, 112, 110.5, 107.5,
      104, 100, 94.5, 88.5, 81.5, 73, 63.5, 53, 41.5, 28.5, 14.5, -1, -18, -36,
      -55.5, -76.5, -98.5, -122, -147, -173.5, -200.5, -229.5, -259.5, -290.5,
      -322.5, -355.5, -389.5, -424, -459.5, -495.5, -532, -568.5, -605, -641.5,
      -678, -714, -749, -783.5, -817, -849, -879.5, -908.5, -935, -959.5, -981,
      -1000.5, -1016, -1028.5, -1037.5, -1042.5, -1043.5, -1040, -1031.5,
      1018.5, 1e3, 976, 946.5, 911, 869.5, 822, 767.5, 707, 640, 565.5, 485,
      397, 302.5, 201, 92.5, -22.5, -144, -272.5, -407, -547.5, -694, -846,
      -1003, -1165, -1331.5, -1502, -1675.5, -1852.5, -2031.5, -2212.5, -2394,
      -2576.5, -2758.5, -2939.5, -3118.5, -3294.5, -3467.5, -3635.5, -3798.5,
      -3955, -4104.5, -4245.5, -4377.5, -4499, -4609.5, -4708, -4792.5, -4863.5,
      -4919, -4958, -4979.5, -4983, -4967.5, -4931.5, -4875, -4796, -4694.5,
      -4569.5, -4420, -4246, -4046, -3820, -3567, 3287, 2979.5, 2644, 2280.5,
      1888, 1467.5, 1018.5, 541, 35, -499, -1061, -1650, -2266.5, -2909, -3577,
      -4270, -4987.5, -5727.5, -6490, -7274, -8077.5, -8899.5, -9739, -10594.5,
      -11464.5, -12347, -13241, -14144.5, -15056, -15973.5, -16895.5, -17820,
      -18744.5, -19668, -20588, -21503, -22410.5, -23308.5, -24195, -25068.5,
      -25926.5, -26767, -27589, -28389, -29166.5, -29919, -30644.5, -31342,
      -32009.5, -32645, -33247, -33814.5, -34346, -34839.5, -35295, -35710,
      -36084.5, -36417.5, -36707.5, -36954, -37156.5, -37315, -37428, -37496,
      37519, 37496, 37428, 37315, 37156.5, 36954, 36707.5, 36417.5, 36084.5,
      35710, 35295, 34839.5, 34346, 33814.5, 33247, 32645, 32009.5, 31342,
      30644.5, 29919, 29166.5, 28389, 27589, 26767, 25926.5, 25068.5, 24195,
      23308.5, 22410.5, 21503, 20588, 19668, 18744.5, 17820, 16895.5, 15973.5,
      15056, 14144.5, 13241, 12347, 11464.5, 10594.5, 9739, 8899.5, 8077.5,
      7274, 6490, 5727.5, 4987.5, 4270, 3577, 2909, 2266.5, 1650, 1061, 499,
      -35, -541, -1018.5, -1467.5, -1888, -2280.5, -2644, -2979.5, 3287, 3567,
      3820, 4046, 4246, 4420, 4569.5, 4694.5, 4796, 4875, 4931.5, 4967.5, 4983,
      4979.5, 4958, 4919, 4863.5, 4792.5, 4708, 4609.5, 4499, 4377.5, 4245.5,
      4104.5, 3955, 3798.5, 3635.5, 3467.5, 3294.5, 3118.5, 2939.5, 2758.5,
      2576.5, 2394, 2212.5, 2031.5, 1852.5, 1675.5, 1502, 1331.5, 1165, 1003,
      846, 694, 547.5, 407, 272.5, 144, 22.5, -92.5, -201, -302.5, -397, -485,
      -565.5, -640, -707, -767.5, -822, -869.5, -911, -946.5, -976, -1e3,
      1018.5, 1031.5, 1040, 1043.5, 1042.5, 1037.5, 1028.5, 1016, 1000.5, 981,
      959.5, 935, 908.5, 879.5, 849, 817, 783.5, 749, 714, 678, 641.5, 605,
      568.5, 532, 495.5, 459.5, 424, 389.5, 355.5, 322.5, 290.5, 259.5, 229.5,
      200.5, 173.5, 147, 122, 98.5, 76.5, 55.5, 36, 18, 1, -14.5, -28.5, -41.5,
      -53, -63.5, -73, -81.5, -88.5, -94.5, -100, -104, -107.5, -110.5, -112,
    ...
    (p.QUANT_TAB = { A: 91, B: 94, C: 8, D: 12 }),
    (p.QUANT_LUT_STEP_2 = [
      [p.QUANT_TAB.C, p.QUANT_TAB.C, p.QUANT_TAB.D],
      [p.QUANT_TAB.A, p.QUANT_TAB.A, p.QUANT_TAB.A],
      [p.QUANT_TAB.B, p.QUANT_TAB.A, p.QUANT_TAB.B],
    ]),
    (p.QUANT_LUT_STEP_3 = [
  ...
  var f = (function (A) {
    function i(t) {
      var i;
      return (
        ((i = A.call(this, t) || this).onDecodeCallback = t.onAudioDecode),
        (i.module = t.wasmModule),
    ...
    return (
      ...
      (e.bufferWrite = function (A) {
        ...
        for (var t = 0, i = 0; i < A.length; i++) t += A[i].length;
        for (
          var e = this.functions._mp2_decoder_get_write_ptr(this.decoder, t),
            s = 0;
          s < A.length;
          s++
        )
          this.instance.heapU8.set(A[s], e), (e += A[s].length);
        return this.functions._mp2_decoder_did_write(this.decoder, t), t;
      }),
      (e.decode = function () {
        var A = Q();
        if (!this.decoder) return !1;
        if (0 === this.functions._mp2_decoder_decode(this.decoder)) return !1;
        if (
          (this.sampleRate ||
          ...
          var t = this.functions._mp2_decoder_get_left_channel_ptr(
              this.decoder
            ),
            ...
            o = this.instance.heapF32.subarray(s, s + i.SAMPLES_PER_FRAME),
            g = this.instance.heapF32.subarray(I, I + i.SAMPLES_PER_FRAME);
          this.destination.play(this.sampleRate, o, g);
        }
        this.advanceDecodedTime(i.SAMPLES_PER_FRAME / this.sampleRate);
        var a = Q() - A;
        return this.onDecodeCallback && this.onDecodeCallback(this, a), !0;
      }),
      (e.getCurrentTime = function () {
        var A = this.destination ? this.destination.enqueuedTime : 0;
        return this.decodedTime - A;
  ...
  f.SAMPLES_PER_FRAME = 1152;
  var m = (function () {
    function A(A) {
      A.canvas
        ? ((this.canvas = A.canvas), (this.ownsCanvasElement = !1))
        : ((this.canvas = document.createElement("canvas")),
          (this.ownsCanvasElement = !0)),
    ...
    return (
      (t.initGL = function () {
        ...
        var e = new Float32Array([0, 0, 0, 1, 1, 0, 1, 1]);
        t.bindBuffer(t.ARRAY_BUFFER, this.vertexBuffer),
          t.bufferData(t.ARRAY_BUFFER, e, t.STATIC_DRAW),
          (this.program = this.createProgram(
            A.SHADER.VERTEX_IDENTITY,
            A.SHADER.FRAGMENT_YCRCB_TO_RGBA
          )),
          (i = t.getAttribLocation(this.program, "vertex")),
          ...
          (this.loadingProgram = this.createProgram(
            A.SHADER.VERTEX_IDENTITY,
            A.SHADER.FRAGMENT_LOADING
          )),
          (i = t.getAttribLocation(this.loadingProgram, "vertex")),
          t.enableVertexAttribArray(i),
          t.vertexAttribPointer(i, 2, t.FLOAT, !1, 0, 0),
          (this.shouldCreateUnclampedViews = !this.allowsClampedTextureData());
      }),
      (t.handleContextLost = function (A) {
        A.preventDefault(), (this.contextLost = !0);
      }),
      (t.handleContextRestored = function () {
        this.initGL();
      }),
      (t.destroy = function () {
        var A = this.gl;
        this.deleteTexture(A.TEXTURE0, this.textureY),
          ...
          this.ownsCanvasElement && this.canvas.remove();
      }),
      ...
      (t.createProgram = function (A, t) {
        var i = this.gl,
          e = i.createProgram();
        return (
          i.attachShader(e, this.compileShader(i.VERTEX_SHADER, A)),
      ...
      (t.render = function (A, t, i, e) {
        if (this.enabled) {
          ...
          e &&
            ...
            this.updateTexture(s.TEXTURE0, this.textureY, I, o, A),
            this.updateTexture(s.TEXTURE1, this.textureCb, g, a, t),
            this.updateTexture(s.TEXTURE2, this.textureCr, g, a, i),
    ...
    R = (function () {
      ...
      return (
        (t.destroy = function () {
          this.gain.disconnect(),
            ...
            0 === this.context._connections &&
              (this.context.close(), (A.CachedContext = null));
        }),
        (t.play = function (A, t, i) {
          if (this.enabled) {
            if (!this.unlocked) {
              var e = Q();
              return (
                this.wallclockStartTime < e && (this.wallclockStartTime = e),
                void (this.wallclockStartTime += t.length / A)
              );
            }
            this.gain.gain.value = this.volume;
            var s = this.context.createBuffer(2, t.length, A);
            s.getChannelData(0).set(t), s.getChannelData(1).set(i);
            var I = this.context.createBufferSource();
            (I.buffer = s), I.connect(this.destination);
            var o = this.context.currentTime,
              g = s.duration;
            this.startTime < o &&
              ((this.startTime = o), (this.wallclockStartTime = Q())),
        ...
        (t.getEnqueuedTime = function () {
          return Math.max(this.wallclockStartTime - Q(), 0);
        }),
        (t.resetEnqueuedTime = function () {
          (this.startTime = this.context.currentTime),
            (this.wallclockStartTime = Q());
        }),
        (t.unlock = function (A) {
        ...
        (t.checkIfUnlocked = function (A, t) {
          ...
          A.playbackState === A.FINISHED_STATE
            ...
            : t < 10 &&
              setTimeout(this.checkIfUnlocked.bind(this, A, t + 1), 100);
        }),
  ...
  var k = (function () {
      function A() {
        (this.stackSize = 5242880),
          ...
          (this.ready = !1),
          (this.loadingFromFileStarted = !1),
          (this.loadingFromBufferStarted = !1);
      }
      var t = A.prototype;
      return (
        (t.write = function (A) {
          this.loadFromBuffer(A);
        }),
        (t.loadFromFile = function (A, t) {
          if (
            (t && this.onInitCallbacks.push(t), !this.loadingFromFileStarted)
          ) {
            (this.loadingFromFileStarted = !0), (this.onInitCallback = t);
            var i = new n(A, {});
        ...
        (t.loadFromBuffer = function (A, t) {
          var i = this;
          if (
            (t && this.onInitCallbacks.push(t), !this.loadingFromBufferStarted)
          )
            if (
              ((this.loadingFromBufferStarted = !0),
              ...
              (this.brk = this.align(
                ...
                WebAssembly.instantiate(A, { env: e }).then(function (A) {
                  (i.instance = A.instance),
                    i.instance.exports.__post_instantiate &&
                      i.instance.exports.__post_instantiate(),
                    i.createHeapViews(),
                    (i.ready = !0);
                  for (var t = 0; t < i.onInitCallbacks.length; t++)
                    i.onInitCallbacks[t](i);
                });
            } else
              for (var s = 0; s < this.onInitCallbacks.length; s++)
                this.onInitCallbacks[s](null);
        }),
        ...
        (t.c_sbrk = function (A) {
          var t = this.brk;
          if (((this.brk += A), this.brk > this.memory.buffer.byteLength)) {
        ...
        (t.readDylinkSection = function (A) {
          var t = new Uint8Array(A),
            ...
            e = function () {
              for (var A = 0, e = 1; ; ) {
                var s = t[i++];
                if (((A += (127 & s) * e), (e *= 128), !(128 & s))) return A;
              }
            },
            s = function (A) {
        ...
        (A.GetModule = function () {
          return (
            (A.CACHED_MODULE = A.CACHED_MODULE || new A()), A.CACHED_MODULE
          );
        }),
        A
      );
    ...
    G = (function () {
      function A(A, t, i) {
        ...
        if (
          ...
          t.source
            ...
            : A.match(/^wss?:\/\//)
            ? ((this.source = new d(A, this.options)), (t.streaming = !0))
            : t.progressive
            ? ((this.source = new h(A, this.options)), (t.streaming = !1))
            : ((this.source = new n(A, this.options)), (t.streaming = !1)),
          (this.maxAudioLag = t.maxAudioLag || 0.25),
          (this.loop = !1 !== t.loop),
          (this.autoplay = !!t.autoplay || t.streaming),
          (this.demuxer = new l(t)),
          this.source.connect(this.demuxer),
          !t.disableWebAssembly &&
            k.IsSupported() &&
            ((this.wasmModule = k.GetModule()),
            (t.wasmModule = this.wasmModule)),
          !1 !== t.video &&
            ((this.video = t.wasmModule ? new D(t) : new w(t)),
            (this.renderer =
              !t.disableGl && m.IsSupported() ? new m(t) : new y(t)),
            this.demuxer.connect(l.STREAM.VIDEO_1, this.video),
            this.video.connect(this.renderer)),
          !1 !== t.audio &&
            R.IsSupported() &&
            ((this.audio = t.wasmModule ? new f(t) : new p(t)),
            (this.audioOut = new R(t)),
            this.demuxer.connect(l.STREAM.AUDIO_1, this.audio),
      ...
      return (
        ...
        (t.update = function () {
          (this.animationId = requestAnimationFrame(this.update.bind(this))),
            this.source.established
              ? (this.isPlaying ||
                  ((this.isPlaying = !0),
                  (this.startTime = Q() - this.currentTime),
        ...
        (t.nextFrame = function () {
          return (
            !(!this.source.established || !this.video) && this.video.decode()
          );
        }),
        ...
        (t.updateForStaticFile = function () {
          ...
          if (this.audio && this.audio.canPlay) {
            for (
              ;
              !A && this.audio.decodedTime - this.audio.currentTime < 0.25;
            ...
            var i = Q() - this.startTime + this.video.startTime,
              e = i - this.video.currentTime,
              s = 1 / this.video.frameRate;
            this.video &&
              e > 0 &&
              (e > 2 * s && (this.startTime += e), (A = !this.video.decode())),
          ...
          this.source.resume(t),
            A && this.source.completed
              ? this.loop
                ? this.seek(0)
                : (this.stop(),
                  this.options.onEnded && this.options.onEnded(this))
              : A && this.options.onStalled && this.options.onStalled(this);
        }),
        A
      );
    })();
  return {
    ...
    Source: {
      ...
      Fetch: (function () {
        ...
        return (
          ...
          (t.start = function () {
            var A = this,
              t = { method: "GET", headers: new Headers(), cache: "default" };
            self
              .fetch(this.url, t)
              .then(function (t) {
            ...
            return A.read()
              .then(function (i) {
                if (!i.done)
                  return t.aborted
                    ? A.cancel()
                    : (t.destination && t.destination.write(i.value.buffer),
                      t.pump(A));
                t.completed = !0;
              })
              .catch(function (A) {
    ...
    Renderer: { WebGL: m, Canvas2D: y },
    AudioOutput: { WebAudio: R },
    WASMModule: k,
    Now: Q,
